            ...
            <div class="width-15">
                ...
                <div class="topButtons">
                    <ul>
                        <li>
                            <button>
                                <a href="./logging.php"><h1>Log In</h1></a>
                            </button>
                            <button>
        ...
        <div class="container">
            <div class="width-6">
                ...
                <?php foreach ($largeStories as $s) { ?>
                    <div class="alignment">
                        <div class="largeBox option-1" style="background-image: url('<?= $s->img_url ?>');" >
                        ...
                        <a href="news/category.php?id=1"><button>Read more</button></a>
                    </div>
                <?php } ?>
                </div>  
            </div>
            ...
            <!-- Medium Boxs -->
            <div class="width-9">
                <div class="mediumBoxs">
                <?php foreach ($mediumStories2 as $s) { ?>
                    <div class="alignment">
                        <div class="mediumBox option-1" style="background-image: url('<?= $s->img_url ?>');">
                            <button class="category"><?=$s->getCategory()?></button>
                        </div>
                        <div class="content">
                            <div class="titleIcon">
                                <a href="#">    
                                    <h1><?= $s->short_headline ?></h1>
                                </a>
                                <a href="#"><i class="fa-solid fa-message"></i></a>
                            </div>
                            <a href="#">
                            ...
                            <div class="information">
                                <a href="#">
                                    <h2><i><?= Author::findById($s->author_id)->first_name . " " . Author::findById($s->author_id)->last_name ?><div class="blue"> - <?= $s->getFormattedDate($s->created_at) ?></div></i></h2>
                                </a>
                                <a href="news/category.php?id=1"><button>Read more</button></a>
                            </div>
                        </div>
        ...
        <div class="container">
            <div class="width-3">
                ...
                <?php foreach ($mediumStories as $s) { ?>
                    <div class="alignment">
                        <div class="smallBox option-1" style="background-image: url('<?= $s->img_url ?>');">
                            <button class="category"><?=$s->getCategory()?></button>
                        </div>
                        <a href="#">
                            <h1><?= $s->headline ?></h1>
